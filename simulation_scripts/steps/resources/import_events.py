...
def frameFinder(frame):
        """
        #print I3EventHeader information
        """
        frame['OldRunNumber']=dataclasses.I3Double(frame["I3EventHeader"].run_id)
        frame['OldEventID']=dataclasses.I3Double(frame["I3EventHeader"].event_id)
