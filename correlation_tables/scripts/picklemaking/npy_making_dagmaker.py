...
def get_Grid_job(infile):
    ...
    job_name = 'make_npy '
    lines =[
        'JOB ' + job_name + ' /home/zrechav/SelfVeto_Correlation_Tables/scripts/picklemaking/npy_maker.sub',
...
outfile_name='/home/zrechav/SelfVeto_Correlation_Tables/scripts/picklemaking/dags/' + dataset + '_' + subdir + '_npy_maker.dag'
