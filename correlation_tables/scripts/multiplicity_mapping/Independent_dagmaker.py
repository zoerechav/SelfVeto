...
def get_Grid_job(infile):
    ...
    lines =[
        'JOB ' + job_name + ' /home/zrechav/SelfVeto_Correlation_Tables/scripts/multiplicity_mapping/MultiplicityHistograms_Independent.sub',
...
outfile_name='/home/zrechav/SelfVeto_Correlation_Tables/scripts/multiplicity_mapping/dags/' + dataset + '_' + subdir + '_multiplicities_Independent.dag'
